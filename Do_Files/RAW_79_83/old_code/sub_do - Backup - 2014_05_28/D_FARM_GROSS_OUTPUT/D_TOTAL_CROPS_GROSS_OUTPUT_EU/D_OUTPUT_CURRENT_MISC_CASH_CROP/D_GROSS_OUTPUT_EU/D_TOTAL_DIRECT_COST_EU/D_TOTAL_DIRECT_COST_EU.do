...
* I_TOTAL_HOME_GROWN_SEED_EU is the sum of all 
*  HOME_GROWN_SEED_VALUE_EUXXXX (which has already
*  been calculated). See the do file for 
*  I_TOTAL_HOME_GROWN_SEED_EU, which is just
*  commentary. 

* D_FERTILISER_COST_EU has also been calculated 
