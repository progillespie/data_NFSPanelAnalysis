...
local this_file_calculates "D_MACHINERY_OPERATING_EXP_EU"
...
replace MACHINERY_MINOR_REPAIRS_EU= 0 /// 
   if missing(MACHINERY_MINOR_REPAIRS_EU)

replace MACHINERY_TAX_EU= 0 /// 
   if missing(MACHINERY_TAX_EU)

replace MACHINERY_INSURANCE_EU = 0 /// 
   if missing(MACHINERY_INSURANCE_EU)
...
gen  `this_file_calculates' =    ///
 ...
 MACHINERY_MINOR_REPAIRS_EU        + /// 
 MACHINERY_TAX_EU                  + /// 
 MACHINERY_INSURANCE_EU
...
global required_vars "$required_vars MACHINERY_MINOR_REPAIRS_EU"
global required_vars "$required_vars MACHINERY_TAX_EU"
global required_vars "$required_vars MACHINERY_INSURANCE_EU"
