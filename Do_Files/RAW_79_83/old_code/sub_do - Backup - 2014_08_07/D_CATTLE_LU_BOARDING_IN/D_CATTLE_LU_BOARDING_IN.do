...
local this_file_calculates "D_CATTLE_LU_BOARDING_IN"
...
local var "BOARDING_IN_CATTLE_ANIMALS_NO"
capture drop `var'
    gen `var' = 0
    replace `var' = ///
      (                                     ///
...
local var "BOARDING_IN_CATTLE_DAYS_NO"
capture drop `var'
    gen `var' = 0
    replace `var' = ///
      (                                       ///
...
local var "BOARDING_IN_CATTLE_LU_EQUIV"
capture drop `var'
    gen `var' = 0
    replace `var' = ///
      (                                       ///
        BOARDING_IN_DAIRY_CATTLE1_LU_EQ        + ///
        BOARDING_IN_DAIRY_CATTLE2_LU_EQ        + ///
        BOARDING_IN_DAIRY_CATTLE3_LU_EQ        ///
      ) * alloc
...
local vlist "`vlist' BOARDING_IN_CATTLE_ANIMALS_NO"
local vlist "`vlist' BOARDING_IN_CATTLE_DAYS_NO"
local vlist "`vlist' BOARDING_IN_CATTLE_LU_EQUIV"
...
gen double `this_file_calculates' =    ///
  (                                    ///
    BOARDING_IN_CATTLE_ANIMALS_NO      * ///
    (BOARDING_IN_CATTLE_DAYS_NO / 365) * ///
    BOARDING_IN_CATTLE_LU_EQUIV          ///
  )
