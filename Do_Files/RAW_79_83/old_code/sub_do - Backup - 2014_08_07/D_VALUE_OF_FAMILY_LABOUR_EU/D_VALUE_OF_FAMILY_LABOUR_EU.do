...
while `i' < 84 {
	...
	qui do `dodir'/sub_do/_renameSheet/renameSheet57.do
	...
	*============================================================
	/* YEAR_BORN is a 2 digit year. The first two digits are 19 
           if...
	  ...
	  ... otherwise, we should go with 20 as the first two 
          digits, and use that figure to calculate the age. 
	
	 YEAR_BORN has been renamed with a card specific name, e.g. 
         UNPAID_YEAR_BORN                                          */
	*============================================================

	* Create temporary var WorkerAge to simplify eq.
	gen int WorkerAge = 0
	...
	* If <= 14 Hours should be 0, which is what it will be, 
