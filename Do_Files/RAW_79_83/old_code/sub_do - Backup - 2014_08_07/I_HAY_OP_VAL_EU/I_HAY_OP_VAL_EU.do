...
local this_file_calculates "I_HAY_OP_VAL_EU"
...
local vlist "`vlist' HAY_OP_INV_TOTAL_VALUE_EU"
...
replace `this_file_calculates' =     ///
  HAY_OP_INV_QTY_TONNES * 15            ///
                                     ///
  if [HAY_OP_INV_QTY_TONNES     > 0   & ///
      HAY_OP_INV_TOTAL_VALUE_EU == 0  & ///
      HAY_TOTAL_YIELD_TONNES    == 0]
   


replace `this_file_calculates' =     ///
  HAY_OP_INV_TOTAL_VALUE_EU              ///
                                     ///
  if ![HAY_OP_INV_QTY_TONNES     > 0   & ///
       HAY_OP_INV_TOTAL_VALUE_EU == 0  & ///
       HAY_TOTAL_YIELD_TONNES    == 0] & ///
