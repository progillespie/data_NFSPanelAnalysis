...
local this_file_calculates "I_STRAW_FED_UNIT_COST"
...
local term1_codes ///
  "`term1_codes' 8110 8111 8112 8113 8114 8115 8116 8117 8118 8119"
...
local vlist "`vlist' OP_INV_VALUE_EU8110"
local vlist "`vlist' OP_INV_QTY_TONNES_HA8110"
local vlist "`vlist' OP_INV_FED_QTY_TONNES_HA8110"
local vlist "`vlist' CY_FED_QTY_TONNES_HA8111"
local vlist "`vlist' D_TOTAL_DIRECT_COST_EU8111"
local vlist "`vlist' CY_TOTAL_YIELD8111"
...
replace `this_file_calculates' =                 ///
  OP_INV_VALUE_EU8110 / OP_INV_QTY_TONNES_HA8110    ///
                                                 ///
  if OP_INV_FED_QTY_TONNES_HA8110 >                 ///
     CY_FED_QTY_TONNES_HA8111 
...
replace `this_file_calculates' =                      ///
  (                                                   ///
    OP_INV_VALUE_EU8110                                  ///
                   +                                     ///
    (D_TOTAL_DIRECT_COST_EU8111 / CY_TOTAL_YIELD8111)  * ///
    FED_TOTAL_TONNES_HA8111                              ///
  )                                                   ///
                   /                                     ///
  term1                                                  ///
                                                      ///
  if ![OP_INV_FED_QTY_TONNES_HA8110 >                    ///
     CY_FED_QTY_TONNES_HA8111]                         & ///
     CY_TOTAL_YIELD8111 > 0


* 2nd term in numerator is 0 (i.e. omitted) 
*  if CY_TOTAL_YIELD8111 <= 0
replace `this_file_calculates' =         ///
    OP_INV_VALUE_EU8110  / term1            ///
                                         ///
  if ![OP_INV_FED_QTY_TONNES_HA8110 >       ///
     CY_FED_QTY_TONNES_HA8111]            & ///
     CY_TOTAL_YIELD8111 <= 0
