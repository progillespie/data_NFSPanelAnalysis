...
local this_file_calculates "D_DAIRY_LVSTCK_UNITS_INCL_BULLS"
...
(                                             ///
  (MTH12_TOTAL_DAIRY_COWS_NO        / 12) * 1  + ///
  (MTH12_TOTAL_DAIRY_STOCK_BULLS_NO / 12) * 1    ///
)
...
global required_vars "$required_vars MTH12_TOTAL_DAIRY_COWS_NO"
global required_vars "$required_vars MTH12_TOTAL_DAIRY_STOCK_BULLS_NO"
