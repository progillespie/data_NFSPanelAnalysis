...
local this_file_calculates "D_TOTAL_CASUAL_LABOUR_EU"
...
replace CASUAL_WAGES_PAID_EU = 0 /// 
   if missing(CASUAL_WAGES_PAID_EU)
...
global required_vars "$required_vars CASUAL_WAGES_PAID_EU"
