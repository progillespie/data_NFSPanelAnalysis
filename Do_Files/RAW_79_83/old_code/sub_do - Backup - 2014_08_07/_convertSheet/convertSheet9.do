args shortfilename origdata standalone YY 
********************************************************
********************************************************
*
*       Patrick R. Gillespie                            
...
if "`standalone'"=="standalone"{
	di "Year is `YY'"
	import excel using "D:/Data/data_NFSPanelAnalysis/OrigData/RAW_79_83/raw`YY'_head.xls", sheet("Sheet`i'") firstrow clear
}
