* Program to interpret crop codes
*  INPUT ARGUMENT IS : an NFS crop code
*  OUTPUT RETURNED IS: the corresponding parts of the SAS varname
*                       (for use in constructing the varname later)
