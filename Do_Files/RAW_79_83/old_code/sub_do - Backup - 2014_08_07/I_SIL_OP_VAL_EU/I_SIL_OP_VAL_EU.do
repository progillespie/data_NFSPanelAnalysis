...
local this_file_calculates "I_SIL_OP_VAL_EU"
...
local vlist "`vlist' SIL_OP_INV_TOTAL_VALUE_EU"
...
replace `this_file_calculates' =     ///
  SIL_OP_INV_QTY_TONNES * 5            ///
                                     ///
  if [SIL_OP_INV_QTY_TONNES     > 0   & ///
      SIL_OP_INV_TOTAL_VALUE_EU == 0  & ///
      SIL_TOTAL_YIELD_TONNES    == 0]
   


replace `this_file_calculates' =     ///
  SIL_OP_INV_TOTAL_VALUE_EU              ///
                                     ///
  if ![SIL_OP_INV_QTY_TONNES     > 0   & ///
       SIL_OP_INV_TOTAL_VALUE_EU == 0  & ///
       SIL_TOTAL_YIELD_TONNES    == 0] & ///
