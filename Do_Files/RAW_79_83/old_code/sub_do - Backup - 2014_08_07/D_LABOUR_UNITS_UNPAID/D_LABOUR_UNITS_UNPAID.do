...
local this_file_calculates "D_LABOUR_UNITS_UNPAID"
...
* Bring calculated variable into data. 
merge 1:1 farmcode year using temp_appended.dta  ///
  , nogen keep(match master) keepusing(D_LABOUR_UNITS_UNPAID) 
...
label var `this_file_calculates' "UNPAID Farm Workers -- Annual Work Units"
