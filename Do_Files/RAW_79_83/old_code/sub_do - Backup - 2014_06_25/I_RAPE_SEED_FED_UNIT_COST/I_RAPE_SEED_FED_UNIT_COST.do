...
local this_file_calculates "I_RAPE_SEED_FED_UNIT_COST"
...
local term1_codes ///
  "`term1_codes' 9080 9081 9082 9083 9084 9085 9086 9087 9088 9089"
...
local vlist "`vlist' I_OP_INV_VAL_EU9080"
local vlist "`vlist' OP_INV_QTY_TONNES_HA9080"
local vlist "`vlist' OP_INV_FED_QTY_TONNES_HA9080"
local vlist "`vlist' CY_FED_QTY_TONNES_HA9081"
local vlist "`vlist' D_TOTAL_DIRECT_COST_EU9081"
local vlist "`vlist' CY_TOTAL_YIELD9081"
...
replace `this_file_calculates' =     ///
  I_OP_INV_VAL_EU9080              /    ///
  OP_INV_QTY_TONNES_HA9080           ///
                                     ///
  if [OP_INV_FED_QTY_TONNES_HA9080 >    ///
      (CY_FED_QTY_TONNES_HA9081 +       ///
       CY_FED_QTY_TONNES_HA9083)]        
...
replace `this_file_calculates' =     ///
  (                                  ///
   I_OP_INV_VAL_EU9080                  ///
    ...
    (                                ///
      (                              ///
        D_TOTAL_DIRECT_COST_EU9081    + ///
        D_TOTAL_DIRECT_COST_EU9083      ///
                                     ///
      )            /                    ///
      (                              ///
       CY_TOTAL_YIELD9081             + ///
       CY_TOTAL_YIELD9083             - ///
       CY_WASTE_TONNES_HA9081         - ///
       CY_WASTE_TONNES_HA9083           ///
                                     ///
      )            *                    ///
      (                              ///
        FED_TOTAL_TONNES_HA9081       + ///
        FED_TOTAL_TONNES_HA9083         ///
      )                              ///
    )                                ///
  )                /                    ///
                                     ///
  ...
  if ![OP_INV_FED_QTY_TONNES_HA9080 >   ///
         (CY_FED_QTY_TONNES_HA9081 +    ///
          CY_FED_QTY_TONNES_HA9083)]  & ///
     [(CY_FED_QTY_TONNES_HA9081 +       ///
       CY_FED_QTY_TONNES_HA9083) > 0]


* 2nd term in numerator is 0 (i.e. omitted) 
*  if CY_TOTAL_YIELD9081 <= 0
replace `this_file_calculates' =      ///
  I_OP_INV_VAL_EU9080  / term1           ///
                                      ///
  if ![OP_INV_FED_QTY_TONNES_HA9080 >   ///
         (CY_FED_QTY_TONNES_HA9081 +    ///
          CY_FED_QTY_TONNES_HA9083)]  & ///
