...
local this_file_calculates "D_TOTAL_PASTURE_HA"
...
local vlist "`vlist' TOTAL_PASTURE_LEY_HA"
local vlist "`vlist' TOTAL_PASTURE_PERMANENT_HA"
...
gen double `this_file_calculates' =    ///
  TOTAL_PASTURE_LEY_HA                  + ///
  TOTAL_PASTURE_PERMANENT_HA
