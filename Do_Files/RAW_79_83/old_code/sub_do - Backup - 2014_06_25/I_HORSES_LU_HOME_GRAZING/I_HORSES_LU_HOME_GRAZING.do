...
local this_file_calculates "I_HORSES_LU_HOME_GRAZING"
...
local vlist "`vlist' D_HORSES_LIVESTOCK_UNITS"
...
local vlist "`vlist' D_HORSES_LU_BOARDING_OUT"
local vlist "`vlist' D_HORSES_LU_BOARDING_IN"
