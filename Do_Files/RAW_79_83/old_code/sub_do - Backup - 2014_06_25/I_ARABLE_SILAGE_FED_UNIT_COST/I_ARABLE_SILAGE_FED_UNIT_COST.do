...
local this_file_calculates "I_ARABLE_SILAGE_FED_UNIT_COST"
...
gen term1 = 0 
local term1_codes ///
  "`term1_codes' 9030 9031 9032 9033 9034 9035 9036 9037 9038 9039"
...
local vlist "`vlist' I_OP_INV_VAL_EU9030"
local vlist "`vlist' OP_INV_QTY_TONNES_HA9030"
local vlist "`vlist' OP_INV_FED_QTY_TONNES_HA9030"
local vlist "`vlist' CY_FED_QTY_TONNES_HA9031"
local vlist "`vlist' D_TOTAL_DIRECT_COST_EU9031"
local vlist "`vlist' CY_TOTAL_YIELD9031"
...
replace `this_file_calculates' =    ///
  I_OP_INV_VAL_EU9030 / OP_INV_QTY_TONNES_HA9030 ///
  if OP_INV_FED_QTY_TONNES_HA9030 > 0 & ///
     CY_FED_QTY_TONNES_HA9031 == 0
...
replace `this_file_calculates' =       ///
  (                                    ///
    I_OP_INV_VAL_EU9030                   ///
                   +                      ///
    (D_TOTAL_DIRECT_COST_EU9031 / CY_TOTAL_YIELD9031)  * ///
    FED_TOTAL_TONNES_HA9031               ///
  )                                    ///
                   /                      ///
  term1                                   ///
  if ![OP_INV_FED_QTY_TONNES_HA9030 > 0 & ///
     CY_FED_QTY_TONNES_HA9031 == 0]     & ///
     CY_TOTAL_YIELD9031 > 0


* 2nd term in numerator is 0 (i.e. omitted) 
*  if CY_TOTAL_YIELD9031 <= 0
replace `this_file_calculates' =       ///
    I_OP_INV_VAL_EU9030  / term1          ///
  if ![OP_INV_FED_QTY_TONNES_HA9030 > 0 & ///
     CY_FED_QTY_TONNES_HA9031 == 0]     & ///
     CY_TOTAL_YIELD9031 <= 0
