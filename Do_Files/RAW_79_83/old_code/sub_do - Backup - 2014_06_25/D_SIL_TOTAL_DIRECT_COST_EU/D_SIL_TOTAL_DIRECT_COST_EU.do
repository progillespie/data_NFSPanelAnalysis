...
local this_file_calculates "D_SIL_TOTAL_DIRECT_COST_EU"
...
local vlist "`vlist' D_SIL_FERTILISER_COST_EU"
local vlist "`vlist' ALLOCATED_TO_CROP_EU9231"
local vlist "`vlist' I_TOTAL_HOME_GROWN_SEED_EU9231"
...
gen double `this_file_calculates' =    ///
  ...
  ALLOCATED_TO_CROP_EU9231              + ///
  I_TOTAL_HOME_GROWN_SEED_EU9231
