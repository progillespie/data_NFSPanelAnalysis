...
tabstat `this_file_calculates' ///
  BREEDING_STAGS_CLOS_INV_NO   ///
  BREEDING_STAGS_OP_INV_NO     ///
  BREEDING_STAGS_OP_INV_EU     ///
  BREEDING_HINDS_CLOS_INV_NO   ///
  BREEDING_HINDS_OP_INV_NO     ///
  BREEDING_HINDS_CLOS_INV_EU   ///
  OTHER_DEER_LT1YR_CLOS_INV_NO ///
  OTHER_DEER_LT1YR_OP_INV_NO   ///
  OTHER_DEER_LT1YR_CLOS_INV_EU ///
  OTHER_DEER_GT1YR_CLOS_INV_NO ///
  OTHER_DEER_GT1YR_OP_INV_NO   ///
  OTHER_DEER_GT1YR_CLOS_INV_EU ///
  D_DEER_SALES_EU              ///
  , by(year)
