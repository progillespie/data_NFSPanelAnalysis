...
local this_file_calculates "D_INVESTMENT_IN_MACHINERY"
...
replace PMA_REPLACE_NET_VALUE = 0 /// 
   if missing(PMA_REPLACE_NET_VALUE)

replace OMA_REPLACE_NET_VALUE= 0 /// 
   if missing(OMA_REPLACE_NET_VALUE)
...
gen  `this_file_calculates' =    ///
 PMA_REPLACE_NET_VALUE            + ///
 OMA_REPLACE_NET_VALUE 
