...
local this_file_calculates "I_MAIZE_SILAGE_FED_UNIT_COST"
...
local term1_codes ///
  "`term1_codes' 9020 9021 9022 9023 9024 9025 9026 9027 9028 9029"
...
local vlist "`vlist' I_OP_INV_VAL_EU9020"
local vlist "`vlist' OP_INV_QTY_TONNES_HA9020"
local vlist "`vlist' OP_INV_FED_QTY_TONNES_HA9020"
local vlist "`vlist' CY_FED_QTY_TONNES_HA9021"
local vlist "`vlist' D_TOTAL_DIRECT_COST_EU9021"
local vlist "`vlist' CY_TOTAL_YIELD9021"
...
replace `this_file_calculates' =                 ///
  I_OP_INV_VAL_EU9020 / OP_INV_QTY_TONNES_HA9020    ///
                                                 ///
  if OP_INV_FED_QTY_TONNES_HA9020 > 0             & ///
     CY_FED_QTY_TONNES_HA9021 == 0
...
replace `this_file_calculates' =                      ///
  (                                                   ///
    I_OP_INV_VAL_EU9020                                  ///
                   +                                     ///
    (D_TOTAL_DIRECT_COST_EU9021 / CY_TOTAL_YIELD9021)  * ///
    FED_TOTAL_TONNES_HA9021                              ///
  )                                                   ///
                   /                                     ///
  term1                                                  ///
                                                      ///
  if ![OP_INV_FED_QTY_TONNES_HA9020 > 0                & ///
     CY_FED_QTY_TONNES_HA9021 == 0]                    & ///
     CY_TOTAL_YIELD9021 > 0


* 2nd term in numerator is 0 (i.e. omitted) 
*  if CY_TOTAL_YIELD9021 <= 0
replace `this_file_calculates' =         ///
    I_OP_INV_VAL_EU9020  / term1            ///
                                         ///
  if ![OP_INV_FED_QTY_TONNES_HA9020 > 0   & ///
     CY_FED_QTY_TONNES_HA9021 == 0]       & ///
     CY_TOTAL_YIELD9021 <= 0
