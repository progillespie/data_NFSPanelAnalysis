...
while `i' < 84 {
	...
	qui do sub_do/_renameSheet/renameSheet58.do
	...
	* Thats the non-casual labour calculated, but we need casual labour
	*  too. That's simpler though. 

	import excel using raw`i'_head.xls ///
          , firstrow sheet("Sheet59") clear
	rename farm farmcode
	qui do sub_do/_renameSheet/renameSheet59.do
