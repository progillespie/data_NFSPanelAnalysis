...
local this_file_calculates "D_DAIRY_LU_BOARDING_OUT"
...
capture drop BOARDING_OUT_DAIRY_ANIMALS_NO           
    gen BOARDING_OUT_DAIRY_ANIMALS_NO = 0
    replace BOARDING_OUT_DAIRY_ANIMALS_NO = ///
      (                                     ///
...
capture drop BOARDING_OUT_DAIRY_DAYS_NO 
    gen BOARDING_OUT_DAIRY_DAYS_NO = 0
    replace BOARDING_OUT_DAIRY_DAYS_NO =      ///
      (                                       ///
...
local vlist "`vlist' BOARDING_OUT_DAIRY_ANIMALS_NO"
local vlist "`vlist' BOARDING_OUT_DAIRY_DAYS_NO"
...
gen double `this_file_calculates' =      ///
  BOARDING_OUT_DAIRY_ANIMALS_NO           * ///
  (BOARDING_OUT_DAIRY_DAYS_NO / 365)      * 1
...
global required_vars "`required_vars' BOARDING_OUT_DAIRY_ANIMALS_NO"
global required_vars "`required_vars' BOARDING_OUT_DAIRY_DAYS_NO"
