...
*====================================================================
rename UnpaidFarmWorkersYearBorn   UNPAID_YEAR_BORN
rename UnpaidFarmWorkersWorkerCode UNPAID_WORKER_CODE
rename UnpaidFarmWorkersTimeWorked UNPAID_DAYS_WORKED
rename F                           UNPAID_HOURS_WORKED
rename UnpaidFarmWorkersCapitalWor UNPAID_CAPITAL_WORK_DAYS
rename WagesCalculated             UNPAID_WAGES_CALCULATED
rename LabourUnitEquivalent        UNPAID_LABOUR_UNIT_EQUIVALENT
*====================================================================
