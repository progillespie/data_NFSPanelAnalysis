...
if "`standalone'"=="standalone"{
	import excel using "D:/Data/data_NFSPanelAnalysis/OrigData/RAW_79_83/raw79_head.xls", sheet("Sheet4") firstrow clear
}
...
*====================================================================
rename OpeningInventoryQuantityto OP_INV_QTY_TONNES_HA
rename OpeningInventoryValue      OP_INV_VALUE_EU
rename SalesQuantitytonsha        OP_INV_SALES_QTY_TONNES_HA
rename SalesValue                 OP_INV_SALES_VALUE_EU
rename FedQuantitytonsha          OP_INV_FED_QTY_TONNES_HA
rename FedValue                   OP_INV_FED_VALUE_EU
rename SeedQuantity               OP_INV_SEED_QTY_TONNES_HA
rename SeedValue                  OP_INV_SEED_VALUE_EU
rename AllowancesHousetonshaa     OP_INV_ALLOW_HOUSE_TONNES_HA
rename AllowancesWagestonsha      OP_INV_ALLOW_WAGES_TONNES_HA
rename Wastetonsha                OP_INV_WASTE_TONNES_HA
rename ClosingInventoryQuantityto OP_INV_CLOSING_QTY_TONNES_HA
rename ClosingInventoryValue      OP_INV_CLOSING_VALUE_EU
*====================================================================
capture drop junk*
