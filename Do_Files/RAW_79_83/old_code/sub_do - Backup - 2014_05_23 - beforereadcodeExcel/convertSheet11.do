...
*       
* 	
*       The SAS variables created relate to crop disposal
* 	and grazing
* 	
*
*	
...
if "`standalone'"=="standalone"{
	import excel using "D:/Data/data_NFSPanelAnalysis/OrigData/RAW_79_83/raw79_head.xls", sheet("Sheet11") firstrow clear
}
...
*====================================================================
rename AmountFedDairy               FED_DAIRY_TONNES_HA
rename AmountFedCattle              FED_CATTLE_TONNES_HA
rename AmountFedSheep               FED_SHEEP_TONNES_HA
rename AmountFedPigs                FED_PIGS_TONNES_HA
rename AmountFedPoultry             FED_POULTRY_TONNES_HA
rename AmountFedHorses              FED_HORSES_TONNES_HA
rename AmountFedOtherFarmyardAnimal FED_OTHER_FARMYARD_HA 
rename AmountFedOtherGrazingAnimals FED_OTHER_GRAZING
rename AmountFedTotal               FED_TOTAL_TONNES_HA
*====================================================================
* Removed "ANIMALS" from varnames to avoid invalid varnames later on
*  when I append crop codes to the names
capture drop junk*
