...
local this_file_calculates "I_KALE_FED_UNIT_COST"
...
gen term1 = 0 
local term1_codes ///
  "`term1_codes' 9070 9071 9072 9073 9074 9075 9076 9077 9078 9079"
...
local vlist "`vlist' I_OP_INV_VAL_EU9070"
local vlist "`vlist' OP_INV_QTY_TONNES_HA9070"
local vlist "`vlist' OP_INV_FED_QTY_TONNES_HA9070"
local vlist "`vlist' CY_FED_QTY_TONNES_HA9071"
local vlist "`vlist' D_TOTAL_DIRECT_COST_EU9071"
local vlist "`vlist' CY_TOTAL_YIELD9071"
...
replace `this_file_calculates' =    ///
  I_OP_INV_VAL_EU9070 / OP_INV_QTY_TONNES_HA9070 ///
  if OP_INV_FED_QTY_TONNES_HA9070 > ///
     CY_FED_QTY_TONNES_HA9071 
...
replace `this_file_calculates' =       ///
  (                                    ///
    I_OP_INV_VAL_EU9070                   ///
                   +                      ///
    (D_TOTAL_DIRECT_COST_EU9071 / CY_TOTAL_YIELD9071)  * ///
    FED_TOTAL_TONNES_HA9071               ///
  )                                    ///
                   /                      ///
  term1                                   ///
  if ![OP_INV_FED_QTY_TONNES_HA9070 >    ///
       CY_FED_QTY_TONNES_HA9071 ]      & ///
     CY_TOTAL_YIELD9071 > 0


* 2nd term in numerator is 0 (i.e. omitted) 
*  if CY_TOTAL_YIELD9071 <= 0
replace `this_file_calculates' =       ///
    I_OP_INV_VAL_EU9070  / term1          ///
  if ![OP_INV_FED_QTY_TONNES_HA9070 >     ///
       CY_FED_QTY_TONNES_HA9071]        & ///
     CY_TOTAL_YIELD9071 <= 0
