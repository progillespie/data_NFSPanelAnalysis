...
local this_file_calculates "I_FODDER_BEET_FED_UNIT_COST"
...
gen term1 = 0 
local term1_codes ///
  "`term1_codes' 9060 9061 9062 9063 9064 9065 9066 9067 9068 9069"
...
local vlist "`vlist' I_OP_INV_VAL_EU9060"
local vlist "`vlist' OP_INV_QTY_TONNES_HA9060"
local vlist "`vlist' OP_INV_FED_QTY_TONNES_HA9060"
local vlist "`vlist' CY_FED_QTY_TONNES_HA9061"
local vlist "`vlist' D_TOTAL_DIRECT_COST_EU9061"
local vlist "`vlist' CY_TOTAL_YIELD9061"
...
replace `this_file_calculates' =    ///
  I_OP_INV_VAL_EU9060 / OP_INV_QTY_TONNES_HA9060 ///
  if OP_INV_FED_QTY_TONNES_HA9060 > 0 & ///
     CY_FED_QTY_TONNES_HA9061 == 0
...
replace `this_file_calculates' =       ///
  (                                    ///
    I_OP_INV_VAL_EU9060                   ///
                   +                      ///
    (D_TOTAL_DIRECT_COST_EU9061 / CY_TOTAL_YIELD9061)  * ///
    FED_TOTAL_TONNES_HA9061               ///
  )                                    ///
                   /                      ///
  term1                                   ///
  if ![OP_INV_FED_QTY_TONNES_HA9060 > 0 & ///
     CY_FED_QTY_TONNES_HA9061 == 0]     & ///
     CY_TOTAL_YIELD9061 > 0


* 2nd term in numerator is 0 (i.e. omitted) 
*  if CY_TOTAL_YIELD9061 <= 0
replace `this_file_calculates' =       ///
    I_OP_INV_VAL_EU9060  / term1          ///
  if ![OP_INV_FED_QTY_TONNES_HA9060 > 0 & ///
     CY_FED_QTY_TONNES_HA9061 == 0]     & ///
     CY_TOTAL_YIELD9061 <= 0
