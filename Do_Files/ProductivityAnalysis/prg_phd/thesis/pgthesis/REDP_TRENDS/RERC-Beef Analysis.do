...
local nfsdatadir d:\data\data_NFSPanelAnalysis\OutData
local Regional_outdatadir d:\data\data_NFSPanelAnalysis\OutData\RegionalAnalysis
...
* Output Data
local outdatadir d:\data\data_NFSPanelAnalysis\OutData\MPA


log using `outdatadir'\MPAThesis.log, replace 
