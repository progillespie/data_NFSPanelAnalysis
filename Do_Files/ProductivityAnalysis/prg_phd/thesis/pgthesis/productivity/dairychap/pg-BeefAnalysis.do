...
local workdir d:\pglocal
local dodir `workdir'\data\data_NFSPanelAnalysis\Do_Files\InequalityAnalysis
local nfsdatadir `workdir'\data\data_NFSPanelAnalysis\OutData
local Regional_outdatadir `workdir'\data\data_NFSPanelAnalysis\OutData\RegionalAnalysis
...
* Output Data
local outdatadir `workdir'\data\data_NFSPanelAnalysis\OutData\dychap
