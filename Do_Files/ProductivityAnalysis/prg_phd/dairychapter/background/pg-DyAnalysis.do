...
* Output Data
local outdatadir data\data_NFSPanelAnalysis\OutData\ProductivityAnalysis
...
tabstat coprcfno coslcfno coprwnno coslwnno coprstno coslstno coslfcno coprbhno coslbhno coprocno coslocno  cotftdno cotffdno cpavno06 -cpavno2p if ncattle > 0 & fsizesu >= 2 & droporig == 0 & system == 1 & year == 2009  [weight = wt], by(cpagecat) stats(mean)
tab cpagecat cpseaprd if fsizesu >= 2 & droporig == 0 & year == 2009 
tab cpagecat cptyrear if fsizesu >= 2 & droporig == 0 & year == 2009 
tab cpagecat region if fsizesu >= 2 & droporig == 0 & year == 2009 [iweight = wt]
