*gen t=0  *seems unnecessary to index time... just use year instead
...
* rename fsubexno	sub27 ** missing from 8409v0.dta
...
* rename fsubcapd	sub55 *** missing from 8409v0.dta
