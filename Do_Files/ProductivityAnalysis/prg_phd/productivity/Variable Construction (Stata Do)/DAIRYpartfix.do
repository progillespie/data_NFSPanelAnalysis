...
replace PTotalOutputs=98.8 if t ==1997
replace PTotalOutputs=98.0 if t ==1998 
replace PTotalOutputs=94.0 if t==1999
replace PTotalOutputs=100.0 if t==2000
replace PTotalOutputs=104.3 if t==2001
replace PTotalOutputs=100.0 if t==2002
replace PTotalOutputs=99.6 if t==2003
replace PTotalOutputs=101.8 if t==2004
replace PTotalOutputs=102.3 if t==2005
replace PTotalOutputs=107.42 if t==2006


gen PPrimeCattle=0
replace	PPrimeCattle=101.0	if	year<=1996
replace	PPrimeCattle=95.2	if	year==1997
replace	PPrimeCattle=93.4	if	year==1998
replace	PPrimeCattle=90.9	if	year==1999
replace	PPrimeCattle=100.0	if	year==2000
replace	PPrimeCattle=92.5	if	year==2001
replace	PPrimeCattle=95.2	if	year==2002
replace	PPrimeCattle=93.3	if	year==2003
replace	PPrimeCattle=101.9	if	year==2004
replace	PPrimeCattle=105.6	if	year==2005
...
replace	PCowSlaughter=100.0	if	year==2000
replace	PCowSlaughter=86.7	if	year==2001
replace	PCowSlaughter=83.2	if	year==2002
replace	PCowSlaughter=86.4	if	year==2003
replace	PCowSlaughter=103.2	if	year==2004
replace	PCowSlaughter=107.1	if	year==2005
...
replace	PStoreCattle=83.0	if	year==1999
replace	PStoreCattle=100.0	if	year==2000
replace	PStoreCattle=97.2	if	year==2001
replace	PStoreCattle=100.7	if	year==2002
replace	PStoreCattle=102.8	if	year==2003
replace	PStoreCattle=112.3	if	year==2004
replace	PStoreCattle=104.6	if	year==2005
...
replace	PTotalCattle=100.0	if	year==2000
replace	PTotalCattle=92.3	if	year==2001
replace	PTotalCattle=94.4	if	year==2002
replace	PTotalCattle=93.6	if	year==2003
replace	PTotalCattle=103.3	if	year==2004
replace	PTotalCattle=105.6	if	year==2005
...
replace	PSheep=100.0	if	year==2000
replace	PSheep=142.9	if	year==2001
replace	PSheep=121.3	if	year==2002
replace	PSheep=119.5	if	year==2003
replace	PSheep=117.7	if	year==2004
replace	PSheep=109.6	if	year==2005
replace	PSheep=112.21	if	year==2006


gen PMilk=0
replace	PMilk=105.4	if	year<=1996
replace	PMilk=97.8	if	year==1997
replace	PMilk=101.1	if	year==1998
replace	PMilk=98.4	if	year==1999
replace	PMilk=100.0	if	year==2000
replace	PMilk=104.3	if	year==2001
replace	PMilk=97.1	if	year==2002
replace	PMilk=95.6	if	year==2003
replace	PMilk=95.3	if	year==2004
replace	PMilk=93.5	if	year==2005
replace	PMilk=90.13	if	year==2006
...
replace	PCereals=99.0	if	year==1998
replace	PCereals=104.8	if	year==1999
replace	PCereals=100.0	if	year==2000
replace	PCereals=104.5	if	year==2001
replace	PCereals=91.8	if	year==2002
replace	PCereals=109.0	if	year==2003
replace	PCereals=100.9	if	year==2004
replace	PCereals=96.6	if	year==2005
replace	PCereals=110.56	if	year==2006



gen PSugarBeet=0
replace	PSugarBeet=96.0	if	year<=1996
replace	PSugarBeet=97.6	if	year==1997
replace	PSugarBeet=98.6	if	year==1998
replace	PSugarBeet=99.5	if	year==1999
replace	PSugarBeet=100.0	if	year==2000
replace	PSugarBeet=102.8	if	year==2001
replace	PSugarBeet=103.8	if	year==2002
replace	PSugarBeet=103.8	if	year==2003
...
replace	PPotatoes=73.0	if	year==1997
replace	PPotatoes=146.5	if	year==1998
replace	PPotatoes=118.2	if	year==1999
replace	PPotatoes=100.0	if	year==2000
replace	PPotatoes=152.1	if	year==2001
replace	PPotatoes=148.0	if	year==2002
replace	PPotatoes=154.2	if	year==2003
replace	PPotatoes=97.6	if	year==2004
replace	PPotatoes=145.5	if	year==2005
...
replace	PVeg=100.0	if	year==2000
replace	PVeg=105.4	if	year==2001
replace	PVeg=114.9	if	year==2002
replace	PVeg=110.0	if	year==2003
replace	PVeg=110.7	if	year==2004
replace	PVeg=116.1	if	year==2005
...
replace	PTotalCrop=100.0	if	year==2000
replace	PTotalCrop=112.2	if	year==2001
replace	PTotalCrop=110.4	if	year==2002
replace	PTotalCrop=116.0	if	year==2003
replace	PTotalCrop=104.4	if	year==2004
replace	PTotalCrop=112.0	if	year==2005
...
replace	PTotalInputs=93.0	if	year==1998
replace	PTotalInputs=94.1	if	year==1999
replace	PTotalInputs=100.0	if	year==2000
replace	PTotalInputs=104.8	if	year==2001
replace	PTotalInputs=106.1	if	year==2002
replace	PTotalInputs=108.8	if	year==2003
replace	PTotalInputs=113.1	if	year==2004
replace	PTotalInputs=118.0	if	year==2005
...
replace	PCalfFeed=100.0	if	year==2000
replace	PCalfFeed=103.9	if	year==2001
replace	PCalfFeed=105.8	if	year==2002
replace	PCalfFeed=106.8	if	year==2003
replace	PCalfFeed=110.1	if	year==2004
replace	PCalfFeed=116.4	if	year==2005
...
replace	PCattleFeed=100.0	if	year==2000
replace	PCattleFeed=106.4	if	year==2001
replace	PCattleFeed=107.8	if	year==2002
replace	PCattleFeed=107.7	if	year==2003
replace	PCattleFeed=111.7	if	year==2004
replace	PCattleFeed=108.9	if	year==2005
...
replace	PfertiliserNPK=100.0	if	year==2000
replace	PfertiliserNPK=111.6	if	year==2001
replace	PfertiliserNPK=108.4	if	year==2002
replace	PfertiliserNPK=111.5	if	year==2003
replace	PfertiliserNPK=112.2	if	year==2004
replace	PfertiliserNPK=121.2	if	year==2005
...
replace	PfertiliserPK=100.0	if	year==2000
replace	PfertiliserPK=104.5	if	year==2001
replace	PfertiliserPK=103.3	if	year==2002
replace	PfertiliserPK=105.0	if	year==2003
replace	PfertiliserPK=106.2	if	year==2004
replace	PfertiliserPK=110.0	if	year==2005
replace	PfertiliserPK=115.92	if	year==2006



gen PTotalFert=0
replace	PTotalFert=101.0	if	year<=1996
replace	PTotalFert=94.8	if	year==1997
replace	PTotalFert=91.3	if	year==1998
replace	PTotalFert=93.3	if	year==1999
replace	PTotalFert=100.0	if	year==2000
replace	PTotalFert=113.4	if	year==2001
replace	PTotalFert=110.5	if	year==2002
replace	PTotalFert=113.0	if	year==2003
replace	PTotalFert=115.1	if	year==2004
replace	PTotalFert=124.5	if	year==2005
...
replace	PSeeds=102.0	if	year==1998
replace	PSeeds=102.1	if	year==1999
replace	PSeeds=100.0	if	year==2000
replace	PSeeds=103.7	if	year==2001
replace	PSeeds=107.4	if	year==2002
replace	PSeeds=115.2	if	year==2003
replace	PSeeds=116.1	if	year==2004
replace	PSeeds=115.7	if	year==2005
...
replace	PMotorFuels=100.0	if	year==2000
replace	PMotorFuels=95.8	if	year==2001
replace	PMotorFuels=94.7	if	year==2002
replace	PMotorFuels=99.1	if	year==2003
replace	PMotorFuels=110.2	if	year==2004
replace	PMotorFuels=131.7	if	year==2005
...
replace	PElectricity=100.0	if	year==1998
replace	PElectricity=100.0	if	year==1999
replace	PElectricity=100.0	if	year==2000
replace	PElectricity=101.5	if	year==2001
replace	PElectricity=105.9	if	year==2002
replace	PElectricity=119.6	if	year==2003
replace	PElectricity=125.7	if	year==2004
replace	PElectricity=135.7	if	year==2005
...
replace	PTotalEnergy=100.0	if	year==2000
replace	PTotalEnergy=97.1	if	year==2001
replace	PTotalEnergy=97.1	if	year==2002
replace	PTotalEnergy=102.9	if	year==2003
replace	PTotalEnergy=112.6	if	year==2004
...
replace	PPlantProtection=100.0	if	year==2000
replace	PPlantProtection=100.8	if	year==2001
replace	PPlantProtection=101.6	if	year==2002
replace	PPlantProtection=101.6	if	year==2003
replace	PPlantProtection=103.2	if	year==2004
replace	PPlantProtection=102.7	if	year==2005
...
replace	PVetExp=100.0	if	year==2000
replace	PVetExp=104.7	if	year==2001
replace	PVetExp=109.4	if	year==2002
replace	PVetExp=114.7	if	year==2003
replace	PVetExp=115.8	if	year==2004
replace	PVetExp=117.6	if	year==2005
...
replace	POtherInputs=100.0	if	year==2000
replace	POtherInputs=105.9	if	year==2001
replace	POtherInputs=110.4	if	year==2002
replace	POtherInputs=114.1	if	year==2003
replace	POtherInputs=116.9	if	year==2004
replace	POtherInputs=121.0	if	year==2005
replace	POtherInputs=124.04	if	year==2006


gen	CPI=0		
replace	CPI=117.1	if	year<=1996
replace	CPI=118.8	if	year==1997
replace	CPI=121.7	if	year==1998
replace	CPI=123.7	if	year==1999
replace	CPI=130.6	if	year==2000
replace	CPI=137	if	year==2001
replace	CPI=143.3	if	year==2002
replace	CPI=148.3	if	year==2003
replace	CPI=151.6	if	year==2004
replace	CPI=155.3	if	year==2005
replace	CPI=160	if	year==2006
			
			
gen	PTransportcap=0		
replace	PTransportcap=96.736231	if	year<=1996
replace	PTransportcap=97.4031069	if	year==1997
replace	PTransportcap=98.3445787	if	year==1998
replace	PTransportcap=99.2468225	if	year==1999
replace	PTransportcap=100.0166667	if	year==2000
replace	PTransportcap=101.3416667	if	year==2001
replace	PTransportcap=102.9916667	if	year==2002
replace	PTransportcap=103.95	if	year==2003
replace	PTransportcap=104.3	if	year==2004
replace	PTransportcap=105.6916667	if	year==2005
replace	PTransportcap=106.6909091	if	year==2006
			
			
gen	POthercap=0		
replace	POthercap=93.2354049	if	year<=1996
replace	POthercap=94.2824859	if	year==1997
replace	POthercap=96.0903955	if	year==1998
replace	POthercap=98.2071563	if	year==1999
replace	POthercap=100.0083333	if	year==2000
replace	POthercap=101.9166667	if	year==2001
replace	POthercap=103.1333333	if	year==2002
replace	POthercap=103.3666667	if	year==2003
replace	POthercap=103.6166667	if	year==2004
replace	POthercap=104.3833333	if	year==2005
replace	POthercap=105.3727273	if	year==2006
