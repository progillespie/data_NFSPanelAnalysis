...
*only looking to add a few years to the back end of the dataset, so cut out pre 96
keep if year > 1995

*generate time index using 1996 as year 1
gen t= year - 1995  

*rename variables for use with variable construction do file.
rename wt w
