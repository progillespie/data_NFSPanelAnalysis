...
capture tabstat `var'_test2 `var'_EU_p1 if `var'_NO_b == 1, by(YE_AR) stats(mean)
capture tabstat `var'_test2 `var'_EU_p1 if `var'_NO_b == 1, by(YE_AR) stats(count)
...
capture tabstat `var'_test2 `var'_EU_p1 if `var'_NO_12 == 1 | `var'_NO_12 == 2, by(YE_AR) stats(mean)
capture tabstat `var'_test2 `var'_EU_p1 if `var'_NO_12 == 1 | `var'_NO_12 == 2, by(YE_AR) stats(count)
...
capture tabstat `var'_test2 `var'_EU_p1 if `var'_NO_12 == 1, by(YE_AR) stats(mean)
capture tabstat `var'_test2 `var'_EU_p1 if `var'_NO_12 == 1, by(YE_AR) stats(count)
...
capture tabstat `var'_test2 `var'_EU_p1 if `var'_NO_12 == 2, by(YE_AR) stats(mean)
capture tabstat `var'_test2 `var'_EU_p1 if `var'_NO_12 == 2, by(YE_AR) stats(count)
...
capture tabstat `var'_test2 `var'_EU if ((enter_nfs == 0 & `var'_NO > 0 & `var'_NO != .) | (enter_nfs == 1 & `var'_NO > 0 & `var'_NO != . & lagval == 0)), by(YE_AR) stats(mean)
capture tabstat `var'_test2 `var'_EU if ((enter_nfs == 0 & `var'_NO > 0 & `var'_NO != .) | (enter_nfs == 1 & `var'_NO > 0 & `var'_NO != . & lagval == 0)), by(YE_AR) stats(count)
...
* New Entrants
di "New Entrants"
capture tabstat `var'_test2 `var'_EU if enter_nfs == 0 & `var'_NO > 0 & `var'_NO != ., by(YE_AR) stats(mean)
capture tabstat `var'_test2 `var'_EU if enter_nfs == 0 & `var'_NO > 0 & `var'_NO != ., by(YE_AR) stats(count)
...
* New Pruchasers
di "New Purchasers"
capture tabstat `var'_test2 `var'_EU if enter_nfs == 1 & lagval == 0 & `var'_NO > 0 & `var'_NO != ., by(YE_AR) stats(mean)
capture tabstat `var'_test2 `var'_EU if enter_nfs == 1 & lagval == 0 & `var'_NO > 0 & `var'_NO != ., by(YE_AR) stats(count)
