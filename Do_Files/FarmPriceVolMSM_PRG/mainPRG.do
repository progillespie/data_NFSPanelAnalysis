...
*Do-Files
local dodir = "D:\data\Data_NFSPanelANalysis\Do_Files\FarmPriceVolMSM_PRG"
global dodir1 = "`dodir'"

* Original Data
*local OrigData = "D:\DATA\Data_NFSPanelANalysis\OrigData\FarmPriceVolMSM_PRG"
local OrigData ///
...
*local OutData = "D:\data\Data_NFSPanelANalysis\OutData\FarmPriceVolMSM_PRG"
*local OutDataO = "D:\data\Data_NFSPanelANalysis\OutData\FarmPriceVolMSM_PRG\\`s'"
...
* CHANGE-7983: removed from svy_deer_1 vlist3a 
local vlist3a = "cattle_dairy_boarding_com svy_cattle_2 svy_grazing_1"
...
* ------------------------------------------------------------------- 
*  Variable to set to 0 in raw original data (for 79 - 83 only!)
* ------------------------------------------------------------------- 

* CHANGE-7983: Create blank svy_subsidies_grants_1 (don't have it)
do Cr_blank_svy_subsidies_grants.do
save `OrigData'/svy_subsidies_grants.dta, replace

*CHANGE-7983: Create 0-valued SALE_OF_TURF_VALUE_EU to save in 
*  svy_misc_receipts_expenses
use `OrigData'\svy_misc_receipts_expenses.dta, clear
capture gen double SALE_OF_TURF_VALUE_EU = 0
capture gen double USED_IN_HOUSE_TURF_EU = 0
save `OrigData'\svy_misc_receipts_expenses.dta, replace


*CHANGE-7983: create 0 variables for machinery totals tables
use `OrigData'\svy_power_machinery_totals.dta, clear
capture gen double TOTAL_GRANTS_EU        = 0
capture gen double TOTAL_COST_OF_LEASE_EU = 0
save `OrigData'\svy_power_machinery_totals.dta, replace

use `OrigData'\svy_other_machinery_totals.dta, clear
capture gen double TOTAL_GRANTS_EU        = 0
capture gen double TOTAL_COST_OF_LEASE_EU = 0
save `OrigData'\svy_other_machinery_totals.dta, replace
...
* CHANGE-7983: svy_horses_other_1_md was OrigData now OutData 
local svy_horses_other_1_md          = "OutData" 
...
* CHANGE-7983: removed s_b_ALLOC_DEER s_b_ALLOC_GOATS from prvlist4
local prvlist4 = "s_b_ALLOC_DAIRY_HERD s_b_ALLOC_CATTLE s_b_ALLOC_SHEEP s_b_ALLOC_HORSES "
...
drop _merge
* CHANGE-7983: removed d_deer_livestock_units from keep and gen
keep FARM_CODE YE_AR i_horses_lu_home_grazing i_sheep_lu_home_grazing i_cattle_lu_home_grazing i_dairy_lu_home_grazing 
mvencode *, mv(0) override
gen i_total_lu_home_grazing = i_horses_lu_home_grazing + i_sheep_lu_home_grazing + i_cattle_lu_home_grazing + i_dairy_lu_home_grazing
sort  FARM_CODE YE_AR
...
*Cattle DC
* CHANGE-7983: Removed duplicate fed_cattle_tonnes_ha from vlist1
local vlist1 = "sum_i_conc_fed_cattle d_conc_fed_cattle_eu d_total_pasture_eu fed_cattle_tonnes_ha d_livestock_misc_dc_eu d_milk_and_milk_subs_no"
*Sheep DC
...
*Pigs Poultry etc DC
* CHANGE-7983: don't calc deer & goats DC
* d_deer_pasture_eu fed_deer_tonnes_ha fed_goats_tonnes_ha deer_goats_misc_dc_eu
local vlist3 = "sum_i_conc_fed_pigs d_pigs_total_dc_eu sum_i_conc_fed_poultry d_poultry_total_dc_eu sum_i_conc_fed_horses d_horse_pasture_eu fed_horses_tonnes_ha horses_misc_dc_eu "
...
/* D_CONCENTRATES_FED_DAIRY_EU
   D_DAIRY_PASTURE_EU
   D_DAIRY_WINTER_FORAGE_EU        AND 
   D_DAIRY_PRODUCE_MISC_DIRECT_COST_EU   TO GET D_DAIRY_TOTAL_DIRECT_COSTS_EU */
...
drop _merge
sort FARM_CODE YE_AR
* CHANGE-7983: don't merge fed_deer_tonnes or fed_goat_tonnes
...
* CHANGE-7983: leave d_deer_winter_forage = 0
...
* CHANGE-7983: leave d_goats_winter_forage = 0
...
* CHANGE-7983: Don't attempt to load deer & goats datasets
/*
...
*CHANGE-7983: leave d_other_direct_costs = 0
...
capture gen double DAIRY_COWS_SH_BULLS_SUBSIDIES_EU = 0
...
* CHANGE-7983: create 0 variables
capture gen double SUBSIDIES_HEADAGE_EU     = 0
capture gen double SUBSIDIES_EWE_PREMIUM_EU = 0
...
*-------------------------
* CHANGE-7983: don't use svy_deer, just set d_other_ GO to 0 and leave it
/*
...
* CHANGE-7983: keep only d_other_gross_output_eu and identifiers in d_other_gross_output_eu.dta   
keep FARM_CODE YE_AR d_other_gross_output_eu
/*
...
* CHANGE-7983: create 0 variables
capture gen double MILK_QUOTA_LET_EU    = 0
