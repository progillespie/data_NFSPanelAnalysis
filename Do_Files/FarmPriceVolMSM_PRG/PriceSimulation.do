...
* CHANGE-7983: don't replace s_b_ALLOC_*_test2 for DEER & GOATS
*replace s_b_ALLOC_DEER_EU = s_b_ALLOC_DEER_test2
*replace s_b_ALLOC_GOATS_EU = s_b_ALLOC_GOATS_test2

* CHANGE-7983: remove s_b_ALLOC_DEER_EU s_b_ALLOC_GOATS_EU from keep
keep FARM_CODE YE_AR BULKYFEED_CODE s_b_ALLOC_DAIRY_HERD_EU s_b_ALLOC_CATTLE_EU s_b_ALLOC_SHEEP_EU s_b_ALLOC_HORSES_EU  nonzero* hasvar*
