...
** ENTER FILE PATH or OPEN MANUALLY **

use "C:\Documents and Settings\paul\Desktop\SFA workshop\DATA\1996-2005 DAIRY.dta", clear
...
replace DYforagearea=DYforagearea*2.47105 if t==11
...
/*! 
gen EXTEN=advisefee gen EXTEND=0 
...
replace SIZE1=1 if fsize<=75

replace SIZE2=1 if fsize<=100
replace SIZE2=0 if fsize<75

replace SIZE3=1 if fsize<=125
replace SIZE3=0 if fsize<100

replace SIZE4=1 if fsize<=175
replace SIZE4=0 if fsize<125

replace SIZE5=1 if fsize>175
...
keep AI SYS T W FC SCLASS FSIZE FVALUE SEX AGE CHILD5 CHILD15 CHILD19 JOBTYPE CHILD5 CHILD15 CHILD19 LOAN Y1 QTOWN QTLEASE QTLET QT ALLOC- SIZE5
...
sfpanel  lnY lnH lnC lnL lnD lnA lnHH lnHC lnHL lnHD lnHA lnCC lnCL lnCD lnCA lnLL lnLD lnLA lnDD lnDA lnAA T2 T3 T4 T5 T6 T7 T8 T9 T10, model(tfe)
predict utfe, u

******* True Random Effects, Greene (2005)*****
sfpanel  lnY lnH lnC lnL lnD lnA lnHH lnHC lnHL lnHD lnHA lnCC lnCL lnCD lnCA lnLL lnLD lnLA lnDD lnDA lnAA T2 T3 T4 T5 T6 T7 T8 T9 T10, model(tre)
predict utre, u
