...
********* EC (economic costs, i.e. opportunity costs)

* expressed in pounds
gen gbp_fdairyec         = fdairyec         * exchangerate
gen gbp_familylabourcost = familylabourcost * exchangerate
gen gbp_unpaidcapcost    = unpaidcapcost    * exchangerate
gen gbp_decfamlab        = decfamlab        * exchangerate
gen gbp_decunpdcap       = decunpdcap       * exchangerate

* expressed in constant exchange rate euro's 
gen cex_fdairyec	 = gbp_fdairyec     	/cex
gen cex_familylabourcost = gbp_familylabourcost /cex
gen cex_unpaidcapcost    = gbp_unpaidcapcost    /cex
gen cex_decfamlab        = gbp_decfamlab        /cex
gen cex_decunpdcap       = gbp_decunpdcap       /cex
