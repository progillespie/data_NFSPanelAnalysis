...
tabstat `var'_test2 `var'_EU_p1 if `var'_LT_b == 1, by(YE_AR) stats(mean)
tabstat `var'_test2 `var'_EU_p1 if `var'_LT_b == 1, by(YE_AR) stats(count)
...
tabstat `var'_test2 `var'_EU_p1 if `var'_LT_12 == 1 | `var'_LT_12 == 2, by(YE_AR) stats(mean)
tabstat `var'_test2 `var'_EU_p1 if `var'_LT_12 == 1 | `var'_LT_12 == 2, by(YE_AR) stats(count)
...
tabstat `var'_test2 `var'_EU_p1 if `var'_LT_12 == 1, by(YE_AR) stats(mean)
tabstat `var'_test2 `var'_EU_p1 if `var'_LT_12 == 1, by(YE_AR) stats(count)
...
tabstat `var'_test2 `var'_EU_p1 if `var'_LT_12 == 2, by(YE_AR) stats(mean)
tabstat `var'_test2 `var'_EU_p1 if `var'_LT_12 == 2, by(YE_AR) stats(count)
...
tabstat `var'_test2 `var'_EU if ((enter_nfs == 0 & `var'_LT > 0 & `var'_LT != .) | (enter_nfs == 1 & `var'_LT > 0 & `var'_LT != . & lagval == 0)), by(YE_AR) stats(mean)
tabstat `var'_test2 `var'_EU if ((enter_nfs == 0 & `var'_LT > 0 & `var'_LT != .) | (enter_nfs == 1 & `var'_LT > 0 & `var'_LT != . & lagval == 0)), by(YE_AR) stats(count)
...
* New Entrants
di "New Entrants"
tabstat `var'_test2 `var'_EU if enter_nfs == 0 & `var'_LT > 0 & `var'_LT != ., by(YE_AR) stats(mean)
tabstat `var'_test2 `var'_EU if enter_nfs == 0 & `var'_LT > 0 & `var'_LT != ., by(YE_AR) stats(count)
...
* New Pruchasers
di "New Pruchasers"
tabstat `var'_test2 `var'_EU if enter_nfs == 1 & lagval == 0 & `var'_LT > 0 & `var'_LT != ., by(YE_AR) stats(mean)
tabstat `var'_test2 `var'_EU if enter_nfs == 1 & lagval == 0 & `var'_LT > 0 & `var'_LT != ., by(YE_AR) stats(count)
