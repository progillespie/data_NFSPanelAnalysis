...
* Apply Price
**********************************************************************
* No volume change in these variables
capture gen dv`var' = 1
qui replace dv`var' = 1
...
* CHANGE-7983: added capture to following two tabstats
capture tabstat `var'_test2 `var'_EU_p1 if `var'_EU_12 == 1, by(YE_AR) stats(mean)
capture tabstat `var'_test2 `var'_EU_p1 if `var'_EU_12 == 1, by(YE_AR) stats(count)
...
di "New Purchasers Entrants"
* CHANGE-7983: added capture to following two tabstats
capture tabstat `var'_test2 `var'_EU if enter_nfs == 1 & lagval == 0 & `var'_EU > 0 & `var'_EU != ., by(YE_AR) stats(mean)
capture tabstat `var'_test2 `var'_EU if enter_nfs == 1 & lagval == 0 & `var'_EU > 0 & `var'_EU != ., by(YE_AR) stats(count)
